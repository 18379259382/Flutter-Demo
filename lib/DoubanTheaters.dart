...
class _MyHomeAppState extends State<MyHomeApp> {
  ...
  loadData() async {
    String loadRUL = "https://api.douban.com/v2/movie/in_theaters?apikey=0b2bdeda43b5688921839c8ecb20399b&city=深圳&start=0&count=100&client=&udid=";
    ...
    return new ListTile(
      onTap: () {
        Navigator.push(context, new MaterialPageRoute(
          builder: (context)=> new textTiem(todo: subject),
        ));
      },
      title: Card(
        child: row,
